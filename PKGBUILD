...
source=(
    ...
    "0002-Cachy.patch"
    "0001-hdmi-patches.patch"
    "0001-netfilter-Add-netfilter-nf_tables-fullcone-support.patch"
    "0001-netfilter-add-xt_FLOWOFFLOAD-target.patch"
    "0002-amd-isp4.patch"
    "0001-ntfs-patches.patch"
    "0001-tcp-Add-a-sysctl-to-skip-tcp-collapse-processing-whe.patch"
    "0001-tcp_bbr-v3-update-TCP-bbr-congestion-control-module-.patch"
...
case "$_cpusched" in
    ...
    bmq) ## Project C Scheduler
        source+=("0003-prjc-cachy.patch");;
    pds) ## Project C Scheduler
        source+=("0003-prjc-cachy.patch");;
...
prepare() {
    ...
    if [ "$_tcp_bbr3" = "yes" ]; then
        ...
        scripts/config -e NETFILTER_XT_TARGET_NFQUEUE -e NETFILTER_NETLINK_ACCT
    fi
